...
@section('mainContent')
<div class="lg:grid lg:grid-cols-5 mr-56" dir="rtl">
    <div class="bg-gray-100 border-l-8 border-gray-800 mt-20 mb-10 rounded-lg col-span-1 shadow-lg" dir="rtl">
    ...
    <div class="container my-10 pt-5 col-span-4" dir="rtl">
        <div class="bg-gray-100 py-10 mt-4 w-3/4 shadow-sm rounded-md">
                ...
                <div class="rounded overflow-hidden bg-gray-200 border-b border-gray-300 w-11/12 m-auto mb-8 shadow">
                    <div class="text-xl text-gray-600 font-semibold pr-16 pt-2 my-8 mx-6"><!--card head-->
                        <div class="font-bold text-4xl text-gray-600 pb-4 border-b border-gray-600">
                           <span class="ml-5 text-4xl font-extrabold">رزومه:</span>{{$item->title}}
                        </div>
